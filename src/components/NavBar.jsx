    ...
    return (
        <nav className={"w-full flex py-6 justify-between items-center navbar z-100"}>
            ...
            <div className={"flex flex-row-reverse items-center"}>
                <h1 className={"font-glory text-white text-2xl text-xl dark:text-white hidden md:block"}>Tony Ayala</h1>
            ...
            {/*Desktop View*/}
            <ul className={'flex items-center list-none sm:flex hidden justify-end items-center flex-1 z-50'}>
                ...
                <li><a href="./MoraAyalaCurriculumV.pdf" download className={'bg-gradient-to-r from-pink-300 to-pink-200 text-white px-4 py-2 rounded-md'}>Resume</a></li>
            </ul>
            ...
            <div className={"sm:hidden flex flex-1 justify-end items-center"}>
                ...
                <div
                    ...
                    <ul className={'flex items-center list-none flex-col justify-end items-center flex-1 gap-3'}>
                        {navLinks.map(({id, title}, index) => (
                            <li key={id}
